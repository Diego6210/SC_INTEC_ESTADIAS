            ...
            <div class="card-body collapse in">
                <div class="card-block">
                    ...
                    <div class="form-body">
                      ...
                      <div class="row">
                        <div class="col-md-3">
                          <button type="button" class="btn btn-primary"  name="button" onclick="window.open('<?=site_url('Servicio/PDFPaquete/')?><?=$Paquete->IdPaqueteEnvio?>')">Ver PDF <i class="icon-file-pdf"></i></button>
