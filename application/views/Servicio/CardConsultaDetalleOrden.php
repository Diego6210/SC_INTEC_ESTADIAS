            ...
            <div class="card-body collapse in">
                <div class="card-block">
                    ...
                    <div class="form-body">
                      ...
                      <div class="row">
                        <div class="col-md-2">
                          <button type="button" class="btn btn-sm btn-primary"  name="button" onclick="window.open('<?=site_url('Servicio/PDF/')?><?=$Orden->IdOrden?>')">Ver PDF <i class="icon-file-pdf"></i></button>
                        </div>
